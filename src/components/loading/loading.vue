<template>
  <v-overlay z-index="1000" v-model="bool">
    <v-card light width="150" height="150" class="pt-10">
      <v-card-text class="v-card-text pa-0">
        <div style="color: #0094ff" class="la-ball-climbing-dot">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
      ...
      <v-card-actions class="d-flex justify-center mt-2 v-card-actions">正在{{msg}}. . .</v-card-actions>
    </v-card>
  </v-overlay>
</template>
<script>
